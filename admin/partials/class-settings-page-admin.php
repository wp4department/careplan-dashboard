...
class Settings_Page_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url(__DIR__) . 'css/settings-page-admin.css', array(), $this->version, 'all' );
	...
	public function displayPluginAdminDashboard() {
		require_once $this->plugin_name.'-dashboard.php';
  }
